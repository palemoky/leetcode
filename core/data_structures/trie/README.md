...
=== "进阶题"
    ...
    - [211. 添加与搜索单词 - 数据结构设计](https://leetcode.cn/problems/design-add-and-search-words-data-structure/) - 支持通配符
    - [212. 单词搜索 II](https://leetcode.cn/problems/word-search-ii/) - Trie + 回溯
    - [677. 键值映射](https://leetcode.cn/problems/map-sum-pairs/) - 前缀求和
    - [648. 单词替换](https://leetcode.cn/problems/replace-words/) - 词根替换
    - [1268. 搜索推荐系统](https://leetcode.cn/problems/search-suggestions-system/) - 自动补全
